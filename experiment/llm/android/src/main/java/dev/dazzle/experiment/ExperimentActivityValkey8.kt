 ...
 *
 * Mirrors the iOS ExperimentView: kicks off ExperimentPipelineIoTValkey8 on a background
 ...
 */
class ExperimentActivityValkey8 : AppCompatActivity() {
        ...
        Thread {
            ...
            try {
                for (runIndex in 1..runCount) {
                    ...
                    val pipeline = ExperimentPipelineIoTValkey8(
