 ...
 *
 * Dataset: dataset_iot_valkey9.json — 400 readings, 20 checkpoints, 10 fault
 * events (5 pattern types × 2 occurrences) designed to stress memory,
 * annotated with NAMUR NE43 status codes (OK / NO_DATA / OUT_OF_RANGE /
 * FAULT / CALIB_ERROR) for status-aware predictive monitoring.
 */
class ExperimentPipelineIoT(
