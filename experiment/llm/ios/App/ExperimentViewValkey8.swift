...
// ─────────────────────────────────────────────────────────────────────────────
// Wrapped in `extension Valkey8` so the struct coexists with the main baseline
// (App/ExperimentView.swift) and the Paper 2 variant.
extension Valkey8 {

struct ExperimentView: View {

    @StateObject private var pipeline = ExperimentPipelineIoTValkey8()
