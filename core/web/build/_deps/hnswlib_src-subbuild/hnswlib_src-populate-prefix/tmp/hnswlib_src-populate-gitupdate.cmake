...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "v0.8.0"
  WORKING_DIRECTORY "/Users/ivanaliaga/Proyectos/dazzle-sdk-clean/core/web/build/_deps/hnswlib_src-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/ivanaliaga/Proyectos/dazzle-sdk-clean/core/web/build/_deps/hnswlib_src-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/ivanaliaga/Proyectos/dazzle-sdk-clean/core/web/build/_deps/hnswlib_src-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
