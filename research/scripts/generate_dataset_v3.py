...
"""
Generate dataset_v3.json — 400-reading industrial sensor benchmark with NAMUR
...
Output:
    research/data/dataset_v3.json  — full dataset with 400 readings
    experiment/backends/android/assets/dataset_v3.json    (copy)
    experiment/backends/ios/Resources/dataset_v3.json     (copy)
"""
...
OUTPUT_PATH = os.path.join(os.path.dirname(__file__), "..", "data", "dataset_v3.json")
ANDROID_ASSET = os.path.join(
    os.path.dirname(__file__), "..", "..",
    "experiment", "backends", "android", "assets", "dataset_v3.json"
)
IOS_ASSET = os.path.join(
    os.path.dirname(__file__), "..", "..",
    "experiment", "backends", "ios", "Resources", "dataset_v3.json"
)
